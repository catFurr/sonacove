/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc --env-interface CloudflareEnv src/workerd-conf.d.ts` (hash: fa61911cb4aa0aa98418ad798e12bfec)
// Runtime types generated with workerd@1.20250906.0 2025-05-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		PUBLIC_BREVO_WEBHOOK_URL: string;
		BREVO_API_KEY: string;
		PUBLIC_PADDLE_ENVIRONMENT: string;
		PUBLIC_PADDLE_CLIENT_TOKEN: string;
		PUBLIC_PADDLE_PRICE_ID: string;
		PUBLIC_PADDLE_PREMIUM_PRICE_ID: string;
		PUBLIC_PADDLE_ORGANIZATION_PRICE_ID: string;
		PADDLE_WEBHOOK_SECRET: string;
		PADDLE_API_KEY: string;
		PUBLIC_KC_HOSTNAME: string;
		KC_HOSTNAME: string;
		KC_CLIENT_ID: string;
		...
		KC_REGISTRATION_API_URL: string;
		KC_WEBHOOK_URL: string;
		KC_WEBHOOK_EVENT_TYPES: string;
		ACME_EMAIL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BREVO_WEBHOOK_URL" | "BREVO_API_KEY" | "PUBLIC_PADDLE_ENVIRONMENT" | "PUBLIC_PADDLE_CLIENT_TOKEN" | "PUBLIC_PADDLE_PRICE_ID" | "PUBLIC_PADDLE_PREMIUM_PRICE_ID" | "PUBLIC_PADDLE_ORGANIZATION_PRICE_ID" | "PADDLE_WEBHOOK_SECRET" | "PADDLE_API_KEY" | "PUBLIC_KC_HOSTNAME" | "KC_HOSTNAME" | "KC_CLIENT_ID" | "KC_CLIENT_SECRET" | "KC_WEBHOOK_SECRET" | "KC_DB_PASSWORD" | "KC_ADMIN_PASSWORD" | "KC_REGISTRATION_API_URL" | "KC_WEBHOOK_URL" | "KC_WEBHOOK_EVENT_TYPES" | "ACME_EMAIL" | "DISCORD_PUBLIC_KEY" | "DISCORD_BOT_TOKEN" | "GRAFANA_USERNAME" | "GRAFANA_API_KEY" | "CF_WEBHOOK_SECRET" | "DB_HOST" | "DB_PORT" | "DB_USER" | "DB_PASSWORD" | "DB_NAME">> {}
}
